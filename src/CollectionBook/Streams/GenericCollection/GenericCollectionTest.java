...
public class GenericCollectionTest {
    ...
    public static void main(String[] args) {
        ...
        GenericCollection<StringElement> stringCollection =
                new GenericCollection<>();
        GenericCollection<TwoIntegersElement> twoIntegersCollection =
                new GenericCollection<>();
        ...
        if (type2 == 1) { // findAllBetween
            ...
            if (type1 == 1)
                printResultsFromFindAllBetween(integerCollection,
                        start, end);
            else if (type1 == 2)
                printResultsFromFindAllBetween(stringCollection,
                        start, end);
            else
                printResultsFromFindAllBetween(twoIntegersCollection,
                        start, end);
            ...
            if (type1 == 1)
                printResultsFromItemsFromCategories(integerCollection,
                        categories);
            else if (type1 == 2)
                printResultsFromItemsFromCategories(stringCollection,
                        categories);
            else
    ...
    private static void printResultsFromByMonthAndDay(
            GenericCollection<?> collection) {
    ...
    private static void printResultsFromCountByYear(
            GenericCollection<?> collection) {
