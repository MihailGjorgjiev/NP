...
//        return null;
    ...
    static LocalDateTime localDateTimeParse() {
         ...
         */
        return LocalDateTime.parse("2015-06-20 23:07:30".replace(' ','T'));
//        return null;
    }
...
//        return null;
    ...
    static String localDateTimeFormat() {
         ...
         */
        return LocalDateTime.from(ldt).format(DateTimeFormatter.ofPattern("uuuu_MM_dd_HH_mm_ss"));
//        return null;
    }
    ...
    static String toLocalDateTime() {
         ...
         */
        LocalDateTime localDateTime1 = LocalDate.from(ld).atTime(lt);
        LocalDateTime localDateTime2 = LocalTime.from(lt).atDate(ld);
